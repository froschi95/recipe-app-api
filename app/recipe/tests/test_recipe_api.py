...
class PrivateRecipeApiTests(TestCase):
    ...
    def setUp(self):
        ...
        # Make the user an authorized client by logging in
    ...
    def test_create_recipe(self):
        ...
        payload = {
            ...
            'time_minutes': 45,
            'price': Decimal('8.99'),
            'link': 'https://www.bbc.co.uk/food/recies/chickenparmegiana',
        }
    ...
    def test_create_recipe_with_existing_tags(self):
        """Test creating recipe with existing taf"""
    ...
    def test_update_recipe_assign_tag(self):
        """Test assigning an existing ta when updating a recipe"""
    ...
    def test_clear_recipe_tags(self):
        """Test clearing all tags in a recipe"""
    ...
    def test_filter_by_tags(self):
        ...
        recipe3 = create_recipe(title="Fish & Chips", user=self.user)
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        """Test uploding and image to a recipe"""
